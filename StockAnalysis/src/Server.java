...
public class Server implements Runnable{
	...
	private void sendData(StockObj stk){
		...
		try {
			int port;
			if(stk.getSymbol(0).equals("MSFT")){
				port = 10000;
			}
			else if(stk.getSymbol(0).equals("AAPL")){
				port = 10001;
			}
			else if(stk.getSymbol(0).equals("IBM")){
				port = 10002;
			}
			else if(stk.getSymbol(0).equals("TWTR")){
				port = 10003;
			}
			else if(stk.getSymbol(0).equals("LNKD")){
				port = 10004;
			}
			else if(stk.getSymbol(0).equals("TSLA")){
				port = 10005;
			}	
			else if(stk.getSymbol(0).equals("FB")){
				port = 10006;
			}
			else if(stk.getSymbol(0).equals("QCOM")){
				port = 10007;
			}
			else if(stk.getSymbol(0).equals("GOOG")){
				port = 10008;
			}
			else{
				port = 10009;
			...
			s = new Socket("127.0.0.1", port);//Set this port based on symbol
